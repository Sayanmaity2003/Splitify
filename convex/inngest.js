...
export const getUsersWithExpenses = query({
  handler: async (ctx) => {
    ...
    oneMonthAgo.setMonth(now.getMonth() - 1); //Previous month
...
The main working of this function is to return the categories on which user expending on, 
decription, date, part of any group or not etc...
